...
public class ErgebnisBean
{
	public String doAction()
	{
		...
		management.SaveErgebnis("1", "2", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("1", "3", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("1", "4", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("1", "5", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("1", "6", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("1", "7", "1", "PI/2", true, (new Date()).toString());

		management.SaveErgebnis("2", "1", "1", "PI", false, (new Date()).toString());
		management.SaveErgebnis("2", "2", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("2", "3", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("2", "4", "1", "PI/2", true, (new Date()).toString());

		management.SaveErgebnis("3", "1", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("3", "2", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("3", "3", "1", "PI/2", true, (new Date()).toString());

		management.SaveErgebnis("4", "3", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("4", "4", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("4", "5", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("4", "6", "1", "PI/2", true, (new Date()).toString());
		management.SaveErgebnis("4", "7", "1", "PI/2", true, (new Date()).toString());
